...
class PaperAlfaApp {
  ...
  setupPepakuraToolbar() {
    ...
    bindPepBtn('btn-pep-toggle-labels', () => this.viewer2D.toggleLabels());
  ...
  bindPresetButtons() {
    ...
    const loftPresets = {
      ...
      'preset-loft-tail': [
        { id: 1, x: 0, z: 0, d: 265, shape: 'circle' },
        { id: 2, x: 80, z: -22.5, d: 220, shape: 'circle' },
        { id: 3, x: 160, z: -45, d: 175, shape: 'circle' },
